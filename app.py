...
def black_scholes(stock_price, strike_price, time_to_expiration, risk_free_rate, implied_volatility, option_type):
...
def index():
    if request.method == 'POST':
        ...
        option_price = black_scholes(stock_price, strike_price, time_to_expiration, risk_free_rate, implied_volatility, option_type)
